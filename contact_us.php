            ...
            <div class="card rounded-0 card-outline card-navy shadow">
                <div class="card-body rounded-0">
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="fullname" name="fullname" required placeholder="Nombre Completo">
                                <small class="px-3 text-muted">Nombre Completo</small>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="contact" name="contact" required placeholder="Tu número de contacto">
                                <small class="px-3 text-muted">N de Contacto</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="email" class="form-control form-control-sm form-control-border" id="email" name="email" required placeholder="tucorreo@correo.com">
