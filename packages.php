<h1>Nuestros Paquetes de Servicio</h1>
<hr class="border-light">
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="input-group mb-2">
                <input type="search" id="search" class="form-control form-control-border" placeholder="Busca tus paquetes aquí...">
    ...
    <div class="list-group" id="package-list">
        ...
        <?php if ($package->num_rows < 1) : ?>
            <center><span class="text-muted">Sin paquetes listados</span></center>
        <?php endif; ?>
