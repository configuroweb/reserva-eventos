  ...
  <div class="d-flex justify-content-between w-100">
    ...
    <div>
      <?php if ($_settings->userdata('id') > 0) : ?>
        ...
        <?php endif; ?>
      <?php else : ?>
        <a href="./admin" class="mx-2 text-light">Acceso Administrativo</a>
      <?php endif; ?>
    </div>
  </div>
</nav>
<nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-gradient-navy" id='top-Nav'>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a href="./" class="nav-link <?= isset($page) && $page == 'home' ? "active" : "" ?>">Inicio</a>
        </li>
        <li class="nav-item">
          <a href="./?page=packages" class="nav-link <?= isset($page) && $page == 'packages' ? "active" : "" ?>">Paquetes de Servicio</a>
        </li>
        <li class="nav-item">
          <a href="./?page=events" class="nav-link <?= isset($page) && $page == 'events' ? "active" : "" ?>">Eventos</a>
        </li>
        <li class="nav-item">
          <a href="./?page=about" class="nav-link <?= isset($page) && $page == 'about' ? "active" : "" ?>">Acerca de</a>
        </li>
        <li class="nav-item">
          <a href="./?page=contact_us" class="nav-link <?= isset($page) && $page == 'contact_us' ? "active" : "" ?>">Contáctanos</a>
        </li>
        <?php if ($_settings->userdata('id') > 0 && $_settings->userdata('login_type' != 1)) : ?>
          <li class="nav-item">
            <a href="./?page=profile" class="nav-link <?= isset($page) && $page == 'profile' ? "active" : "" ?>">Perfil</a>
          </li>
        <?php endif; ?>
        <!-- <li class="nav-item">
