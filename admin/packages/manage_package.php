...
<div class="container-fluid">
    <form action="" id="package-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Enter Package Name" value="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="price" class="control-label">Price</label>
            <input type="number" name="price" id="price" class="form-control form-control-border text-right" value="<?php echo isset($price) ? $price : '' ?>" required>
        </div>
        <div class="form-group">
