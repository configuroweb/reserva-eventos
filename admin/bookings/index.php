<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<button class="btn btn-flat btn-sm btn-primary" id="create_new"><i class="fa fa-plus"></i> Nueva Reserva</button>
		</div>
	</div>
	<div class="card-body">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td class=""><?php echo date("Y-m-d H:i", strtotime($row['event_schedule'])) ?></td>
...
<script>
	$(document).ready(function() {
		$('#create_new').click(function() {
			uni_modal("Nueva Reserva", "bookings/manage_booking.php", 'mid-large')
		})
		$('.view_data').click(function() {
			uni_modal("Detalles de Reserva", "bookings/view_details.php?id=" + $(this).attr('data-id'), "mid-large")
		})
		$('.delete_data').click(function() {
			_conf("Deseas eliminar esta reserva permanentemente?", "delete_book", [$(this).attr('data-id')])
		})
