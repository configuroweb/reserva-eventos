...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span> Nuevo Evento</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function() {
		$('#create_new').click(function() {
			uni_modal("Agregar Evento", "events/manage_event.php")
		})
		$('.edit_data').click(function() {
			uni_modal("Actualizar Evento", "events/manage_event.php?id=" + $(this).attr('data-id'))
		})
		$('.delete_data').click(function() {
			_conf("Deseas eliminar este evento permanentemente?", "delete_event", [$(this).attr('data-id')])
		})
		$('.view_data').click(function() {
			uni_modal("Información del evento", "events/view_event.php?id=" + $(this).attr('data-id'))
		})
