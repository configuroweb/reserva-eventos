<div class="content py-5">
    <h3 class="text-center"><b>Prestamos servicios para los siguientes Eventos</b></h3>
    <hr class="w-25 border-light">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="input-group mb-2">
                <input type="search" id="search" class="form-control form-control-border" placeholder="Busca tus eventos aquí...">
    ...
    <?php if ($events->num_rows < 1) : ?>
        <center><span class="text-muted">Sin eventos listados aún</span></center>
    <?php endif; ?>
...
<script>
    $(function() {
        $('.view_event').click(function() {
            uni_modal("Información del tipo de evento", "view_event.php?id=" + $(this).attr('data-id'))
        })
